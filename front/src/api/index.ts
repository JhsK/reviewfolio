...
export const postCommentFileUpload = async (params: FormData) => {
  const { data } = await API.post<string[]>('/comment/file', params);
  return data;
};
...
export const putChangeInfo = (params) => API.post('/user/change-info', params);
